...
from .views import SignUpView, CustomerInfo, PasswordResetCompleteView, login_page ,change_password ,user_logout ,user_update,customer_verify ,resend ,custom_password_reset ,reset_password_verify


urlpatterns = [
    path('home/',CustomerInfo.as_view(), name='home'),
